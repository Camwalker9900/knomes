/**
 * API response types for the Knomes API v1.
 *
 * These mirror the Pydantic response schemas in apps/api/app/schemas/ 1:1 —
 * JSON field names are the contract (see plan/CONTRACTS.md, "Response schemas").
 * A shared copy lives in packages/shared/src/contracts.ts; keep both in sync.
 *
 * Dates serialize as ISO-8601 strings. IDs serialize as string UUIDs.
 */
